...
module "ec2_work" {
  ...
  source = "github.com/s3d-club/terraform-aws-ec2?ref=0.1.27-s3d-1002"
...
module "ecr" {
  ...
  source   = "github.com/s3d-club/terraform-aws-ecr?ref=0.1.16-s3d-1002"
...
module "sg_ingress_open" {
  ...
  source = "github.com/s3d-club/terraform-aws-sg_ingress_open?ref=0.1.13-s3d-1001"
