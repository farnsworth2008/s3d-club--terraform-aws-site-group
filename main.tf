...
module "ec2_work" {
  ...
  source = "github.com/s3d-club/terraform-aws-ec2?ref=0.1.24-s3d-1016"
...
module "ecr" {
  ...
  source   = "github.com/s3d-club/terraform-aws-ecr?ref=0.1.12-s3d-1010"
...
module "name" {
  source = "github.com/s3d-club/terraform-external-name?ref=0.1.10-s3d-1011"
...
module "sg_ingress_open" {
  ...
  source = "github.com/s3d-club/terraform-aws-sg_ingress_open?ref=0.1.10-s3d-1008"
